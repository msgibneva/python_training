...
class Subscriber:
    ...
    def __init__(self, firstname=None, secondname=None, lastname=None, nick=None, title=None, companyname=None, homeaddress=None, homephone=None,
                              mobilephone=None, work=None, faxnumber=None, all_phones_frome_home_page=None, email1=None, email2=None, email3=None,
                 all_emails_frome_home_page=None, homesite=None, addresssec=None, sechomenumber=None, notes=None, id=None):
