...
def test_sub_info(app):
    ...
    with allure.step('Given a subscriber[index] = %s info' % index):
    ...
    with allure.step('Then the subscriber info from homepage is equal to the subscriber info from edit page'):
...
def test_sub_db_home_page(app, db):
    with allure.step('Given a subscribers info'):
    ...
    with allure.step('Then the subscriber info from homepage is equal to the subscriber info from database'):
